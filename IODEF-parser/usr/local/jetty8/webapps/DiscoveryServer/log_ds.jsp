...
String logName = isServlet ? "servletbase.log" : "D-Server.log";
...
<title>Discovery Server | Log Viewer</title>
<style>
...
<body>
<form method="get" action="log_ds.jsp">
...
D-Server LOG:<input type="radio" name="log" <%= orgLog %> value="org"/>&nbsp;
<input type="submit"/>
</form>
