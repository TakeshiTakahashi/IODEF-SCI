...
<%
String orgLogName = "InfoSource.log";
...
<title>Information Source | Log Viewer</title>
<style>
...
<body>
<form method="get" action="log_is.jsp">
...
InfoSource LOG:<input type="radio" name="log" <%= orgLog %> value="org"/>&nbsp;
<input type="submit"/>
</form>
